...
joint.shapes.pn.Transition = joint.shapes.basic.Generic.extend({
    ...
    markup: '<g class="rotatable"><g class="scalable"><rect class="root"/><g class="tokens" /></g><text class="label"/></g>',
...
joint.shapes.pn.Cuadradito = joint.shapes.basic.Generic.extend({
