...
\
/*\
1. IE cant handle paths without the `d` attribute for bounding box calculation \
2. IE cant even handle "d" attribute as a css selector (e.g path[d]) so the following rule will\
...
.link-tools .tool-op\tions {\
   display: none;       /* by default, we dont isplay link options tool */\
}\
...
\
.j\oint-link.joint-theme-material .marker-arrowhead {\
    fill: #d0d8e8;\
}\
