           ...
           <font color="black"><h4>Information Model</h4></font>
                     ...
                     <div className="col m4">
                          <div class="card">
                            ...
                            <div class="card-content">
                              <span class="card-title activator grey-text text-darken-4">Operative Indicators</span>
                              <p><a href="/OperativeIndicatorsList">Take me there!</a></p>
                            </div>
                    ...
                    <div className="col m4">
                          <div class="card">
                            ...
                            <div class="card-content">
                              ...
                              <p><a href="/StrategicIndicatorsList">Take me there!</a></p>
                            </div>
                            <div class="card-reveal">
                              <span class="card-title grey-text text-darken-4">Strategic Indicators<i class="material-icons right">X</i></span>
                              <p>Identify indicators to suppport your business' strategy</p>
                    ...
                    <div className="col m4">
                          <div class="card">
                            ...
                            <div class="card-content">
                              <span class="card-title activator grey-text text-darken-4">External Indicators</span>
                              <p><a href="/ExternalIndicatorsList">Take me there!</a></p>
                            </div>
                            <div class="card-reveal">
                              <span class="card-title grey-text text-darken-4">Strategic Indicators<i class="material-icons right">X</i></span>
                              <p>Identify external indicators to suppport your business' strategy</p>
                            </div>
                          </div>
                    </div>
