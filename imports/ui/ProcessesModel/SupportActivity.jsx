...
export default class SupportActivity extends React.Component {
    constructor(props) {
        super(props)
        this.state={
            isInEditMode: false
    ...
    updateService(){
        ...
        supActivitiesContainer.update(query, {$set:{name:newname}}, (err, done) => {
            if (err)
    ...
    deleteObjective(){
        ...
        supActivitiesContainer.remove({_id:id});
    }
    changeEditMode(){
